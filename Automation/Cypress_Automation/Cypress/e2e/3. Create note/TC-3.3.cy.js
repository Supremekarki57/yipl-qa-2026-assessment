  ...
  Cypress._.times(iterations, (index) => {
    ...
    afterEach(() => {
      cy.task("writeApiResults", {
        results: apiResults,
        filename:
          "Cypress_Automation/results_api/Create-note-results-TC-3.json",
      });
      cy.task("writeApiResultsExcel", {
        results: apiResults,
        filename:
          "Cypress_Automation/results_api/Create-note-results-TC-3.xlsx",
      });
    });
    ...
    it(`Iteration ${
      ...
      cy.task("writeToExcel", {
        filePath: "Cypress/results/Create-note-data-TC-3.xlsx",
