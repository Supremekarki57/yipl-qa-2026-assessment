  ...
  Cypress._.times(iterations, (index) => {
    ...
    afterEach(() => {
      cy.task("writeApiResults", {
        results: apiResults,
        filename: "Cypress_Automation/results_api/Create-note-results.json",
      });
      cy.task("writeApiResultsExcel", {
        results: apiResults,
        filename: "Cypress_Automation/results_api/Create-note-results.xlsx",
      });
    });
    ...
    it(`Iteration ${
      ...
      cy.task("writeToExcel", {
        filePath: "Cypress/results/Create-note-data.xlsx",
        sheetName: "Create Note",
        data: testData,
      });
    });
  });
