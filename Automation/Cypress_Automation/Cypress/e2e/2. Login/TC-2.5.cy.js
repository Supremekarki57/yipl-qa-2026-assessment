  ...
  Cypress._.times(iterations, (index) => {
    ...
    afterEach(() => {
      cy.task("writeApiResults", {
        results: apiResults,
        filename: "Cypress_Automation/results_api/Login-results-TC-5.json",
      });
      cy.task("writeApiResultsExcel", {
        results: apiResults,
        filename: "Cypress_Automation/results_api/Login-results-TC-5.xlsx",
      });
    });
    ...
    it(`Iteration ${
      ...
      cy.task("writeToExcel", {
        filePath: "Cypress/results/Login-data-TC-5.xlsx",
        sheetName: "Login",
        data: testData,
      });
    });
