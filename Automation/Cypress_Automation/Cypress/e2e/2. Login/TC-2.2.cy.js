...
const email = "wronggg@yopmail.com";
  ...
  Cypress._.times(iterations, (index) => {
    ...
    afterEach(() => {
      cy.task("writeApiResults", {
        results: apiResults,
        filename: "Cypress_Automation/results_api/Login-results-TC-2.json",
      });
      cy.task("writeApiResultsExcel", {
        results: apiResults,
        filename: "Cypress_Automation/results_api/Login-results-TC-2.xlsx",
      });
    });
    ...
    it(`Iteration ${
      ...
      cy.task("writeToExcel", {
        filePath: "Cypress/results/Login-data-TC-2.xlsx",
        sheetName: "Login",
        data: testData,
      });
    });
