...
describe("Registration Test", () => {
  ...
  afterEach(() => {
    cy.task("writeApiResults", {
      results: apiResults,
      filename: "Cypress/results_api/registration-results-TC-3.json",
    });
    cy.task("writeApiResultsExcel", {
      results: apiResults,
      filename: "Cypress/results_api/registration-results-TC-3.xlsx",
    });
  });
  ...
  Cypress._.times(iterations, (index) => {
    it(`Iteration ${index + 1}: Register new user and capture API calls`, () => {
      ...
      cy.task("writeToExcel", {
        filePath: "Cypress/results/registration-TC-3-data.xlsx",
